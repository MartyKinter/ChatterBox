...
function Contacts({contacts, currentUser, changeChat}){
    ...
    return (
        <div className="contacts-heading flex flex-col h-screen bg-white">
        ...
        <div className="current-user p-3 px-8 mt-2 flex items-center border-t border-gray-200 text-center">
